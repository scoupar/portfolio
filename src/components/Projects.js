        ...
        <div className="projects-container">
          <div className="project-card">
            ...
            <div className="project-text">
              <p>
                Mobile-first linktree-style website for Glasgow instrumental
                band VASA to display all social media / web links in one view.
              </p>
              <p>
                The main purpose of this project was to practice mobile-first
                design and create a responsive webpage for all devices.
              </p>
              <p>
                Created using React, HTML5 and CSS3 and deployed with Firebase
              </p>
              <p></p>
              <br></br>
              <a
          ...
          <div className="project-card">
            ...
            <div className="project-image">
              <ReactPlayer
                className="video"
                url="https://youtu.be/3CIGxUUhcpw"
                controls
              />
            </div>
            <div className="project-text">
              <p>
                Created with a react front-end which is connected to a spring
                boot Java back-end. The app features a reader-focused front
                section where news articles can be viewed and filtered by
                category and journalist. A keyword search function is also used
                to filter articles by their headline.{" "}
              </p>
              <p>
                The site also features an admin section which allows the user to
                add, edit and delete the articles and journalist information
                that is displayed in the front end.
              </p>
              <p>
          ...
          <div className="project-card">
            <div className="project-title">
              ...
              <img
                className="hidden-image"
                src={hellospacebanner}
                alt="hello-space-banner"
                width="300"
              />
              <br></br>
            </div>
            <div className="project-image">
              <ReactPlayer
                className="video"
                url="https://youtu.be/tW9jmAHcNuE"
                controls
              />
            </div>
            <div className="project-text">
              <p>
                Built using React for the front end and an Express server to
                perform CRUD operations on a MongoDb database. The app also
                fetches data from multiple web API's (NASA and SpaceDevs) and
                displays selected data to the user.
              </p>
              <p>
                Libraries such as HighCharts, Leaflet and Canvas are used to
                display information and create an interactive learning
                environment for the user.
              </p>
              <p>
                Notable features include a quiz, information on upcoming
          ...
          <div className="project-card">
            ...
            <div className="project-image">
              <ReactPlayer
                className="video"
                url="https://youtu.be/z43hjhUEKd0"
                controls
              />
            </div>
            <div className="project-text">
              <p>
                This is a stock management app designed to be used in a
                restaurant, however it would also be suitable for use in any
                situation with suppliers and products.{" "}
              </p>
              <p>
                The app is built with the flask python framework and is
                connected to a PostgreSQL database. Full CRUD operations are
                available to the user to manage both products and suppliers.
              </p>
              <p>
                Users are alerted to out of stock items immediately on the home
                page as well as stock level alerters on the main product list.
              </p>
              <p>
