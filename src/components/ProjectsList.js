    ...
    <div className="list-container">
      ...
      <div className="project-text">
        <p>
          ...
          news articles can be viewed and filtered by category and journalist. A
          keyword search function is also used to filter articles by their
          headline.{" "}
        </p>
        <p>
          The site also features an admin section which allows the user to add,
          edit and delete the articles and journalist information that is
          displayed in the front end.
        </p>
        <p>
          Additional features include a fully working weather widget and
          'breaking news' section that pulls real news stories from the News API
      ...
      <div className="project-text">
        <p>
          ...
          CRUD operations on a MongoDb database. The app also fetches data from
          multiple web API's (NASA and SpaceDevs) and displays selected data to
          the user.
        </p>
        <p>
        ...
        <p>
          Notable features include a quiz, information on upcoming launches into
          space and an interactive section that allows the user to move around
          space.
        </p>
      ...
      <div className="project-text">
        ...
        <p>
          The app is built with the flask python framework and is connected to a
          PostgreSQL database. Full CRUD operations are available to the user to
          manage both products and suppliers.
        </p>
        <p>
        ...
        <p>
          This was a solo project undertaken after learning python for 4 weeks.
        </p>
        <br></br>
        <a
          className="demo-button"
