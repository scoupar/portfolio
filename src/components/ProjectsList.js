        ...
        <Toggle img={ccnewsbanner}>
          <div className="project-text">
            <p>
              ...
              Java back-end. The app features a reader-focused front section
              where news articles can be viewed and filtered by category and
              journalist. A keyword search function is also used to filter
              articles by their headline.{" "}
            </p>
            <p>
              The site also features an admin section which allows the user to
              add, edit and delete the articles and journalist information that
